...
feature 'Book Shop', :type => :feature do
  scenario 'is able to show home page' do
  ...
  scenario 'is able to show books' do
    book = FactoryGirl.create(:book)
    visit root_path
  ...
  scenario 'is able to show books of the category' do
  ...
  scenario 'is able to show a single book' do
    book = FactoryGirl.create(:book)
    visit shop_path
